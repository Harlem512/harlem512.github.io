...
Rusted Moss Mod Loader 6 is the future. Featuring [performance improvements](/rm-docs/rmml/api#caching), a [new syntax](/rm-docs/rmml/advanced#indexcsv), [safety features](/rm-docs/rmml/advanced#dev-mode), and an included Mod Manager, modding has never looked better. With this update, RMML's core API has essentially locked in; any future updates cannot modify behavior without breaking future mods or create dependency hell.
