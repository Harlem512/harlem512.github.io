...
[Rusted Moss Mod Loader (RMML)](/rm-docs/intro/rmml) is a tool built by me. It solves a few [technical issues](/rm-docs/intro/rmml#why) with modding and generally makes everything easier. You can also use RMML as a working example of how to bypass the normal mod loading system.
