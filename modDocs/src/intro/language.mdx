...
Because of [boring technical reasons](/rm-docs/modding/rmml#coding-in-one-line), all modded code must fit within one line, using semicolons to separate statements.
